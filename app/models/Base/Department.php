...
abstract class Department implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\app\\models\\Map\\DepartmentTableMap';
    ...
    /**
     * Initializes internal state of app\models\Base\Department object.
     */
     ...
     * @return $this|\app\models\Department The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DepartmentTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[DepartmentTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DepartmentTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[DepartmentTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DepartmentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DepartmentTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DepartmentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DepartmentTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = DepartmentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\app\\models\\Department'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(DepartmentTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(DepartmentTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DepartmentTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[DepartmentTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DepartmentTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('department_id_seq')");
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_NAME)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Department'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Department'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\app\models\Department
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\app\models\Department The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DepartmentTableMap::COL_ID)) {
            $criteria->add(DepartmentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_NAME)) {
            $criteria->add(DepartmentTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_CREATED_AT)) {
            $criteria->add(DepartmentTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(DepartmentTableMap::COL_UPDATED_AT)) {
            $criteria->add(DepartmentTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildDepartmentQuery::create();
        $criteria->add(DepartmentTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \app\models\Department (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\models\Department Clone of current object.
     * @throws PropelException
     */
    ...
    public function initEmployees($overrideExisting = true)
    {
        ...
        $this->collEmployees->setModel('\app\models\Employee');
    }
        ...
        if (null === $this->collEmployees || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEmployees) {
                    ...
                    $collEmployees->setModel('\app\models\Employee');
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildDepartment The current object (for fluent API support)
     */
    public function setEmployees(Collection $employees, ConnectionInterface $con = null)
    {
        ...
        foreach ($employeesToDelete as $employeeRemoved) {
            $employeeRemoved->setDepartment(null);
        }
