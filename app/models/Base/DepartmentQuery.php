...
use app\models\Map\DepartmentTableMap;
 ...
 * @method     ChildDepartmentQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildDepartmentQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method     ChildDepartmentQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildDepartmentQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     ChildDepartmentQuery leftJoinEmployee($relationAlias = null) Adds a LEFT JOIN clause to the query using the Employee relation
 * @method     ChildDepartmentQuery rightJoinEmployee($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Employee relation
 * @method     ChildDepartmentQuery innerJoinEmployee($relationAlias = null) Adds a INNER JOIN clause to the query using the Employee relation
 *
 * @method     ChildDepartmentQuery joinWithEmployee($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Employee relation
 *
 * @method     ChildDepartmentQuery leftJoinWithEmployee() Adds a LEFT JOIN clause and with to the query using the Employee relation
 * @method     ChildDepartmentQuery rightJoinWithEmployee() Adds a RIGHT JOIN clause and with to the query using the Employee relation
 * @method     ChildDepartmentQuery innerJoinWithEmployee() Adds a INNER JOIN clause and with to the query using the Employee relation
 *
 * @method     \app\models\EmployeeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildDepartment|null findOneById(int $id) Return the first ChildDepartment filtered by the id column
 * @method     ChildDepartment|null findOneByName(string $name) Return the first ChildDepartment filtered by the name column
 * @method     ChildDepartment|null findOneByCreatedAt(string $created_at) Return the first ChildDepartment filtered by the created_at column
 * @method     ChildDepartment|null findOneByUpdatedAt(string $updated_at) Return the first ChildDepartment filtered by the updated_at column *
 ...
 * @method     ChildDepartment requireOneByCreatedAt(string $created_at) Return the first ChildDepartment filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildDepartment requireOneByUpdatedAt(string $updated_at) Return the first ChildDepartment filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDepartment> find(ConnectionInterface $con = null) Return ChildDepartment objects based on current ModelCriteria
 * @method     ChildDepartment[]|ObjectCollection findById(int $id) Return ChildDepartment objects filtered by the id column
 * @psalm-method ObjectCollection&\Traversable<ChildDepartment> findById(int $id) Return ChildDepartment objects filtered by the id column
 ...
 * @psalm-method ObjectCollection&\Traversable<ChildDepartment> findByName(string $name) Return ChildDepartment objects filtered by the name column
 * @method     ChildDepartment[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildDepartment objects filtered by the created_at column
 * @psalm-method ObjectCollection&\Traversable<ChildDepartment> findByCreatedAt(string $created_at) Return ChildDepartment objects filtered by the created_at column
 * @method     ChildDepartment[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildDepartment objects filtered by the updated_at column
 * @psalm-method ObjectCollection&\Traversable<ChildDepartment> findByUpdatedAt(string $updated_at) Return ChildDepartment objects filtered by the updated_at column
...
abstract class DepartmentQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \app\models\Base\DepartmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'manychat', $modelName = '\\app\\models\\Department', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, created_at, updated_at FROM department WHERE id = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(DepartmentTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(DepartmentTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DepartmentTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(DepartmentTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(DepartmentTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DepartmentTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }

    /**
     * Filter the query by a related \app\models\Employee object
     *
     * @param \app\models\Employee|ObjectCollection $employee the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByEmployee($employee, $comparison = null)
    {
        if ($employee instanceof \app\models\Employee) {
            return $this
                ->addUsingAlias(DepartmentTableMap::COL_ID, $employee->getDepartmentId(), $comparison);
    ...
    {
        return $this->addUsingAlias(DepartmentTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DepartmentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DepartmentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DepartmentTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(DepartmentTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DepartmentTableMap::COL_CREATED_AT);
    }
