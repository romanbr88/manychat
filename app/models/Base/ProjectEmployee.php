...
/**
 * Base class that represents a row from the 'project_employee' table.
 *
 *
 *
 * @package    propel.generator.app.models.Base
 */
abstract class ProjectEmployee implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\app\\models\\Map\\ProjectEmployeeTableMap';
    ...
    /**
     * Initializes internal state of app\models\Base\ProjectEmployee object.
     */
    ...
    /**
     * Compares this with another <code>ProjectEmployee</code> instance.  If
     * <code>obj</code> is an instance of <code>ProjectEmployee</code>, delegates to
     * <code>equals(ProjectEmployee)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\app\models\ProjectEmployee The current object (for fluent API support)
     */
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ProjectEmployeeTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setEmployeeId($v)
    {
        ...
        if ($this->employee_id !== $v) {
            $this->employee_id = $v;
            $this->modifiedColumns[ProjectEmployeeTableMap::COL_EMPLOYEE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProjectEmployeeTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectEmployeeTableMap::translateFieldName('EmployeeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ProjectEmployeeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\app\\models\\ProjectEmployee'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(ProjectEmployeeTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildProjectEmployeeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProjectEmployee::setDeleted()
     * @see ProjectEmployee::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProjectEmployeeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectEmployeeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectEmployeeTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'project_id';
        }
        if ($this->isColumnModified(ProjectEmployeeTableMap::COL_EMPLOYEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'employee_id';
        }

        $sql = sprintf(
            'INSERT INTO project_employee (%s) VALUES (%s)',
    ...
    {
        $pos = ProjectEmployeeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProjectEmployee'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectEmployee'][$this->hashCode()] = true;
        $keys = ProjectEmployeeTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\app\models\ProjectEmployee
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\app\models\ProjectEmployee The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ProjectEmployeeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ProjectEmployeeTableMap::COL_PROJECT_ID)) {
            $criteria->add(ProjectEmployeeTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ProjectEmployeeTableMap::COL_EMPLOYEE_ID)) {
            $criteria->add(ProjectEmployeeTableMap::COL_EMPLOYEE_ID, $this->employee_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \app\models\ProjectEmployee (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\models\ProjectEmployee Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProject(ConnectionInterface $con = null)
    {
        if ($this->aProject === null && ($this->project_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProject->addProjectEmployees($this);
             */
        }
    ...
    public function getEmployee(ConnectionInterface $con = null)
    {
        if ($this->aEmployee === null && ($this->employee_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmployee->addProjectEmployees($this);
             */
        }
    ...
    {
        if (null !== $this->aProject) {
            $this->aProject->removeProjectEmployee($this);
        }
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeProjectEmployee($this);
        }
    ...
    {
        return (string) $this->exportTo(ProjectEmployeeTableMap::DEFAULT_STRING_FORMAT);
    }
