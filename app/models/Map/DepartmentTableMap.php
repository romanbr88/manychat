...
class DepartmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'app.models.Map.DepartmentTableMap';
     ...
     */
    const OM_CLASS = '\\app\\models\\Department';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'app.models.Department';
     ...
     */
    const COL_ID = 'department.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'department.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'department.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'department.updated_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID, DepartmentTableMap::COL_NAME, DepartmentTableMap::COL_CREATED_AT, DepartmentTableMap::COL_UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID => 0, DepartmentTableMap::COL_NAME => 1, DepartmentTableMap::COL_CREATED_AT => 2, DepartmentTableMap::COL_UPDATED_AT => 3, ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'department.id' => 'ID',
        'DepartmentTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Name' => 'NAME',
        'Department.Name' => 'NAME',
        'name' => 'NAME',
        'department.name' => 'NAME',
        'DepartmentTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'CreatedAt' => 'CREATED_AT',
        'Department.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'department.createdAt' => 'CREATED_AT',
        'DepartmentTableMap::COL_CREATED_AT' => 'CREATED_AT',
        ...
        'updatedAt' => 'UPDATED_AT',
        'department.updatedAt' => 'UPDATED_AT',
        'DepartmentTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\app\\models\\Department');
        $this->setPackage('app.models');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('department_id_seq');
        // columns
    ...
    {
        $this->addRelation('Employee', '\\app\\models\\Employee', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':department_id',
    1 => ':id',
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(DepartmentTableMap::COL_ID);
            $criteria->addSelectColumn(DepartmentTableMap::COL_NAME);
            $criteria->addSelectColumn(DepartmentTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(DepartmentTableMap::COL_UPDATED_AT);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(DepartmentTableMap::COL_ID);
            $criteria->removeSelectColumn(DepartmentTableMap::COL_NAME);
            $criteria->removeSelectColumn(DepartmentTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(DepartmentTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \app\models\Department) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(DepartmentTableMap::DATABASE_NAME);
            $criteria->add(DepartmentTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(DepartmentTableMap::COL_ID) && $criteria->keyContainsValue(DepartmentTableMap::COL_ID) ) {
